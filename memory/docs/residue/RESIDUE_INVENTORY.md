...
| 文件 | 原路径 | 新位置 | 原因 |
|---|---|---|---|
| workbot.md | `memory/kb/projects/workbot.md` | `archive/legacy-workbot/kb/workbot.md` | workbot 项目真相，违反 BOUNDARY 4.1 |
| workbot-truth-model.md | `memory/kb/global/` | `archive/legacy-workbot/kb/` | 同上 |
...
- `memory/kb/global/projects-spec.md` 第 11 节"CE-01 自动化部署"（含 SSH 别名 `ce-01`、IP `192.168.88.15`、Docker 服务名、镜像版本等 AxonHub 专属运维信息）→ 剥离到 `archive/legacy-workbot/projects-spec-axonhub-section.md`
