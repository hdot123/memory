...
- `memory/kb/global/projects-spec.md` 第 11 节"CE-01 自动化部署"（含 SSH 别名 `ce-01`、IP `REDACTED_IP`、Docker 服务名、镜像版本等 AxonHub 专属运维信息）→ 剥离到 `archive/legacy-workbot/projects-spec-axonhub-section.md`
