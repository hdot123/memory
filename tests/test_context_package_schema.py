...
class TestMemoryV1Structure:
    ...
    def test_project_has_canonical_files(self) -> None:
        ...
        assert project["canonical"] == "memory/kb/projects/{scope}/CANONICAL.md"
        assert project["plan"] == "memory/kb/projects/{scope}/PLAN.md"
        assert project["state"] == "memory/kb/projects/{scope}/STATE.md"
        assert project["tasks"] == "memory/kb/projects/{scope}/TASKS.md"
...
class TestV2ToMemoryV1:
    ...
    def test_convert_v2_to_memory_v1(self) -> None:
        ...
        assert result["schema_version"] == MEMORY_V1_VERSION
        assert result["project"]["canonical"] == "memory/kb/projects/{scope}/CANONICAL.md"
...
class TestMemoryV1Identity:
    ...
    def test_identity_returns_same_object(self) -> None:
        pkg: dict[str, Any] = {
            ...
            "project": {"scope": "s", "canonical": "memory/kb/projects/{scope}/CANONICAL.md"},
        }
