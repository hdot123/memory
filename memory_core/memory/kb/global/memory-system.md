...
- `memory_core/memory/kb/global/` — global knowledge
- `memory_core/memory/kb/projects/` — per-project knowledge
- `memory_core/memory/kb/decisions/` — decision records
- `memory_core/memory/kb/lessons/` — lessons learned
...
- memory_core/memory/kb/decisions/INDEX.md
